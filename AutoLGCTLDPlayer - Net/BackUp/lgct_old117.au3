...
;~ 					Mbox("123")
				...
				EndIf
			Case "SV284"
				If IniRead($iniFile, "CHBANG", "isSTop333", 1) = 0 Then
;~ 					Mbox("123")
					Local $count333 = IniRead($iniFile, "CHBANG333", "TodayCHBang333", 0)
					If Third($infoAcc, "200V") Then
						$count333 = $count333 + 1
						IniWrite($iniFile, "CHBANG", "TodayCHBang333", $count333)
						If $count333 > IniRead($iniFile, "CHBANG", "LastCHBang333", 1) Then
							_CHBang()
						EndIf
					EndIf
				EndIf
...
Func _RegClone($WindowHandlem, $port)
	$port = $port1
	$WindowHandle = $WindowHandle1
	AdlibRegister("_ClearApp", 30000)
	ControlClick($WindowHandle, "", "", "left", 1, 218, 265 + 31)
...
;~ 		--------------------------------
		...
		_CtrlClickInGame($WindowHandlem, 179, 417)
		Sleep(100)
		_CtrlClickInGame($WindowHandlem, 179, 417)
		...
		_CtrlClickInGame($WindowHandlem, 155, 477)
		_CtrlClickInGame($WindowHandlem, 155, 477)
		_CtrlClickInGame($WindowHandlem, 155, 477)
