...
;~ 			If (_curSV() = "SV123" Or _curSV() = "SV284" Or _curSV() = "SV279") Then
;~ 				_Mail()
;~ 			EndIf
...
;~ 	khu vuc sung bai bxh
	If Third($infoAcc, "9t") Or IniRead($iniFile, "General", "SV", 0) = "SV120" Or IniRead($iniFile, "General", "SV", 0) = "SV589" Or IniRead($iniFile, "General", "SV", 0) = "SV283" Or IniRead($iniFile, "General", "SV", 0) = "SV281" Or IniRead($iniFile, "General", "SV", 0) = "SV586" Or IniRead($iniFile, "General", "SV", 0) = "SV284" Then
...
Func codeTT($doneCode)
	...
	Local $fileList = @ScriptDir & "\Data\Account\code.txt", $code, $i = 1, $count = _FileCountLines($fileList)
...
Func _repeatIconCode2($code)
	_CtrlClickInGame(195, 225, 1)
	ControlSend($WindowHandle, "", "", "{BS 20}")
;~ 	_OKIF("iconcode")
	Sleep(400)
...
;~ 	kho do
	...
	_ClickUtilSeeImg("iconEmail", 280, 25, 700)
	Sleep(1000)
	...
	while 1
		Sleep(830)
		If _imgSearch("iconEmail") Then
;~ 			Mbox("1")
			ExitLoop
		EndIf
		_CtrlClickInGame(280, 43, 1)
		Sleep(830)
		_CtrlClickInGame(278, 95, 1)
		Sleep(830)
