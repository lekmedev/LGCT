...
;~ 	_ControlClickDrag($render_hwnd,53, 68,207, 68)
	...
	While 1  ;click ulti ud danh ko du
		...
		_CtrlClickInGame(144, 300)
;~ 		Sleep(500)
		If _imgSearch("donePrison", 177, 280, 186 - 177, 293 - 280) = 1 Or _imgSearch("donePrison2", 177, 279, 189 - 177, 294 - 280) = 1 Then
			ExitLoop
		EndIf
	WEnd
EndFunc   ;==>_Prison
