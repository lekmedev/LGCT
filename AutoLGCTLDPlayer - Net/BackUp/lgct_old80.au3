...
Global $port, $x = 0, $y = 0, $WindowHandle, $tenTK, $iniFile, $iGlobal, $iGlobal1, $aPos, $aPoss, $rsMod
...
Func _bmbSearch($SVnoTrim, $SVtrimmed)
	...
	Local $FindBmp = "C:\Users\Admin\Desktop\2pc\AutoLGCTLDPlayer\Data\Images\S" & $SVtrimmed & ".bmp"
	Local $winPos
...
;~ 			MsgBox(0, "", "$a = _BmpImgSearch", 1)
			$aPoss = _BmpImgSearch($Source, $FindBmp, 0, 0, -1, -1, 100, 500)
			If Not @error Then
