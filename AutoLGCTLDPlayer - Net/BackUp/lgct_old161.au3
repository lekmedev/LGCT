...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $x = 0, $y = 0, $tenTK, $iniFile, $iGlobal1, $aPos, $aPoss, $rsMod, $sFilePathvang, $render_hwnd, $WindowHandle, $flag = 1, $motiec = 0 , $motiecsv=0
...
;~ 	Mbox("1")
	_ClickUtilSeeImg("iconDaNhan", 227, 486, 400)
;~ 	Mbox("2")
;~ 	Mbox("DaNhan",1)f
