...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $x = 0, $y = 0, $tenTK, $iniFile, $iGlobal, $iGlobal1, $aPos, $aPoss, $rsMod, $sFilePathvang, $render_hwnd, $WindowHandle,$flagBreak = 1
...
;~ 		--------------------------------------------------------------------------------------------------------
		...
		If _ReadIni(@ScriptDir & "\Data\Account\file.ini", "General", "code", "") <> "" Then
			DoiCode()
		EndIf
		If _curSV() = "SV284" and @MDAY = 18 Then
			_Mail()
		EndIf
