...
Func _CHBang()
	...
	Sleep(300)
	_ADB_CMD_SLEEP("input swipe 700 300 100 300 300", $port, 500)
...
;~ 	if chua vBang---------------------------------
	...
	_CtrlClickInGame($WindowHandle, 47, 361)
	_CtrlClickInGame($WindowHandle, 47, 361)
	_ClickUtilSeeImgNoSleep($WindowHandle, "iconDaXay", 221, 267)
	Sleep(400)
	_CtrlClickInGame($WindowHandle, 257, 72)
	_CtrlClickInGame($WindowHandle, 257, 72)
	_CtrlClickInGame($WindowHandle, 257, 72)
	Sleep(400)
