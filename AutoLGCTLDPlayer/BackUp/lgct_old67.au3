...
;~ 		ocr($infoAcc[1])
	...
	Next
	if ProcessExists(_ReadIni($fileIni, "General", "PID", @AutoItPID)) Then
		ProcessClose(_ReadIni($fileIni, "General", "PID", @AutoItPID))
		Sleep(2000)
		if WinExists("MEmu - ") = 0 Then
			MsgBox(0,"","60S SHUTDƠN",60000)
			Shutdown(12)
			EndIf
	EndIf
...
;~ 	EndIf
	Run(@ComSpec & ' /c ""C:\Program Files\ImageMagick-7.0.10-Q16\magick" convert "C:\Users\Admin\Pictures\MEmu Photo\' & $infoAcc[1] & '.jpg" -crop 42x20+538+110  "D:\Vang\Vang\' & _ReadIni($iniFile, "General", "SV", 0) & '\' & $infoAcc[1] & '.jpg""', "", @SW_HIDE)
EndFunc   ;==>_ThinhAn
...
Func CaptADB($infoAcc)
	Run(@ComSpec & ' /c adb -s 127.0.0.1:' & $port & ' shell screencap -p /sdcard/Pictures/' & $infoAcc[1] & '.jpg&&""C:\Program Files\ImageMagick-7.0.10-Q16\magick" convert "C:\Users\Admin\Pictures\MEmu Photo\Khanh111116.jpg" -crop 42x20+538+110  "C:\Users\Admin\Pictures\MEmu Photo\Khanh111116.jpg""', "", @SW_HIDE)

EndFunc   ;==>CaptADB
;~ magick convert sc.jpg -crop 42x20+538+110  sc1.jpg
