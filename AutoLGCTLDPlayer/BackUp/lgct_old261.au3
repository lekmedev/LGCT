...
;~ 			EndIf;~
			...
			If (_curSV() = "SV284" Or Third($infoAcc, "MoBoss") Or Third($infoAcc, "CheckMail") Or Third($infoAcc, "SV104") Or Third($infoAcc, "SV163") Or _curSV() = "SV287" Or _curSV() = "SV279" Or _curSV() = "SV502" Or _curSV() = "SV278") and (@MDAY = 10 or @MDAY = 25) Then
 				_Mail()
 			EndIf
...
;~ 	khu vuc sung bai bxh
	If Third($infoAcc, "9t") Or IniRead($iniFile, "General", "SV", 0) = "SV468" Or IniRead($iniFile, "General", "SV", 0) = "SV280" Or IniRead($iniFile, "General", "SV", 0) = "SV282" Or IniRead($iniFile, "General", "SV", 0) = "SV472" Or IniRead($iniFile, "General", "SV", 0) = "SV283" Or IniRead($iniFile, "General", "SV", 0) = "SV284" Then
