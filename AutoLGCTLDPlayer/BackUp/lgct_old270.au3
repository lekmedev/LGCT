...
;~ 			$iGlobal1 = $iGlobal11
			...
			If StringInStr($infoAcc[1], "SV", 1) And $flgMT <> 2 Then
				IniWrite($fileIni, "General", "SV", $infoAcc[1])
			ElseIf $infoAcc[2] == 'saicmnpasss' or $infoAcc[2] == 'nullll'  or $infoAcc[2] == '06202000' or $infoAcc[2] == 'xiaomeng' Then
				$iGlobal = $iGlobal + 1
				_WriteIni($iniFile, "General", "BienI", $iGlobal)
				ContinueLoop
			EndIf
...
;~ 			ElseIf $infoAcc[2] == 'saicmnpasss' Then
			ElseIf $infoAcc[2] == 'saicmnpasss' Or $infoAcc[2] == 'xiaomeng' or _curSV() == 'SV554' Then
				$iGlobal = $iGlobal + 1
				_WriteIni($iniFile, "General", "BienI", $iGlobal)
				ContinueLoop
			EndIf
...
;~ 	AdlibRegister("repeatClickHC", 6000)
	...
	Switch StringTrimLeft(_curSV(), 2)
		...
		Case 407, 586, 530, 502, 109, 111, 193
			$Phu = $_Binh_Tay
		Case 381, 182, 380, 433, 408, 416, 417, 148, 149, 283, 282, 281, 280
			$Phu = $_Tran_Nam
		Case 4611
			$Phu = $_Bac_Tinh
		Case 415
