...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $x = 0, $y = 0, $tenTK, $iniFile, $aPos, $aPoss, $rsMod, $sFilePathvang, $render_hwnd, $WindowHandle, $flag = 1, $motiec = 0, $flgMT = 0, $iGlobal, $fkexit = 0, $iGlobal1
...
;~ 	---------------
	...
	AdlibRegister("_ClearApp", 30000)
	EndIf
	If Third($infoAcc, "Pri2son") or _curSV() = "SV284"  Then
...
;~ 	ControlSend($WindowHandle, "", "", "bán clone 10k 1 acc (còn 200 con), nhận sb thỉnh an. Zalo 094.775.9965")
	ControlSend($WindowHandle, "", "", "Ban 200Clone. 1k/1con, Zalo 094.775.9965 (Tin Nhan Tu Dong)")
	Sleep(2000)
;~ 	Mbox("1")
