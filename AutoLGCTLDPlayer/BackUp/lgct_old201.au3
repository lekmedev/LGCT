...
Func Ctruong()
	_OKIF("iconTrangTri")
;~ 	Mbox("1")
	If (_curSV() = "SV284" Or _curSV() = "SV279" Or _curSV() = "SV287") And @HOUR = 20 Then
		Return
	EndIf
;~ 	Sleep(500)
...
;~ 			_ClickUtilSeeImg("doneKillBoss", , 100)
			...
			AdlibRegister("_ClearApp", 190000)
			While 1
...
;~ 	---------------
	...
	_OKIF("iconTrangTri")
;~ 	If _curSV() = "SV284" Or Third($infoAcc, "MoBoss") Or Third($infoAcc, "SVer287") Or _curSV() = "SV278"  Or _curSV() = "SV502" Then
;~ 		tem()
;~ 		_OKIF("iconTrangTri")
;~ 		AdlibRegister("_ClearApp", 30000)
;~ 	EndIf
...
;~ 	khu vuc sung bai bxh
	If Third($infoAcc, "9t") Or IniRead($iniFile, "General", "SV", 0) = "SV468" Or IniRead($iniFile, "General", "SV", 0) = "SV596" Or IniRead($iniFile, "General", "SV", 0) = "SV472" Or IniRead($iniFile, "General", "SV", 0) = "SV283" Or IniRead($iniFile, "General", "SV", 0) = "SV284" Or IniRead($iniFile, "General", "SV", 0) = "SV16" Or IniRead($iniFile, "General", "SV", 0) = "SV185" Or IniRead($iniFile, "General", "SV", 0) = "SV186" Then
...
Func _ADB_CMD($command, $port, $option = 0)
	...
	Else
		...
		while 1
			Sleep(50)
			if $ExitCode = 0 or TimerDiff($time) > 5000 then Return
		WEnd
	endif
