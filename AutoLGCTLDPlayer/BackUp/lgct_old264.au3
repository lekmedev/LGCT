...
;~ 			EndIf;~
			...
			If (_curSV() = "SV271" Or _curSV() = "SV269" Or _curSV() = "SV284" Or Third($infoAcc, "MoBoss") Or Third($infoAcc, "CheckMail") Or Third($infoAcc, "SV104") Or Third($infoAcc, "SV163") Or _curSV() = "SV287" Or _curSV() = "SV279" Or _curSV() = "SV502" Or _curSV() = "SV278") And (@MDAY = 10 Or @MDAY = 25) Then
				_Mail()
			EndIf
