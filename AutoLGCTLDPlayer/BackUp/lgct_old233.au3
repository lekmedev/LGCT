...
;~ 			Mbox($iGlobal)
	While 1
		...
		_Wait4Image("iconGame")
		AdlibRegister("_checkCountTime", 300000)
		$samePWD = "null"
		$iGlobal = _ReadIni($fileIni, "General", "BienI", 1)
;~ 		Mbox($WindowHandle, 1)
...
;~ 			============================================= Vpn
			...
			ElseIf _ReadIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 1) > 80 Then
				_WriteIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 0)
				Sleep(5000)
				ShellExecute(@ScriptDir & "/ChangeProxy.au3")
			EndIf
...
;~ 			============================================= Vpn
			...
			AdlibRegister("_ClearApp", 13000)
			_WriteIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 1 + _ReadIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 1))
			If _ReadIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 1) > 80 Then
				_WriteIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 0)
				Sleep(5000)
				$countTime = TimerInit
				ShellExecute(@ScriptDir & "/ChangeProxy.au3")
...
Func _checkCountTime()
	...
	If TimerDiff($countTime) > 3000 Then
		Mbox("CountTime", 1)
		_WriteIni(@ScriptDir & "\Data\Account\file.ini", "General", "iVPN", 0)
		$countTime = TimerInit()
		Sleep(5000)
