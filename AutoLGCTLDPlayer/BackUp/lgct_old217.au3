...
AdlibRegister("_ClearApp", 10000)
	Sleep(500)
	_ClickUtilSeeImg("iconPopup", 245, 45, 500)
	Sleep(500)
	_CtrlClickInGame(252, 118)
;~ ----------------Temp2


;~ 	If _curSV() = "SV284" Or Third($infoAcc, "MoBoss") Or Third($infoAcc, "SV287") Or _curSV() = "SV278"  Or _curSV() = "SV279" Or _curSV() = "SV283"  Or _curSV() = "SV280" Then
;~ 		tem()
;~ 		_OKIF("iconTrangTri")
;~ 		AdlibRegister("_ClearApp", 30000)
;~ 	EndIf
