...
;~ 	Nhap mat39, 189
	Sleep(300)
;~ 	ControlSend($WindowHandle, "", "", "{DEL}")
;~ 	Sleep(200)
;~ Mbox($infoAcc[1])
Local $tk=$infoAcc[1]
;~ 	ControlSend($WindowHandle, "", "", $infoAcc[1])
	RunWait(@ComSpec & ' /c adb -s 127.0.0.1:' & $port & ' shell input text 222222222222222222 ', @SW_HIDE)
...
;~ 	EndIfbig_daisy083
	Run(@ComSpec & ' /c ""C:\Program Files\ImageMagick-7.0.10-Q16\magick" convert "E:\Temp\LDPhoTo\' & $infoAcc[1] & '.jpg" -crop 65x20+520+110  "D:\Vang\Vang\' & $sFilePathvang & '\' & $infoAcc[1] & '.jpg""', "", @SW_HIDE)
EndFunc   ;==>_ThinhAn
