...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $x = 0, $y = 0, $tenTK, $iniFile, $iGlobal1, $aPos, $aPoss, $rsMod, $sFilePathvang, $render_hwnd, $WindowHandle, $flag = 1
...
;~ 		--------------------------------------------------------------------------------------------------------
			...
			If Third($infoAcc, "Prison") And IsEven(IniRead($iniFile, "General", "Prison", 0)) Then
				_Prison()
			EndIf
