...
;~ 	MsgBox(0,$x,$y)
;~ 	_CtrlClick($WindowHandle, 173, 59)
;~ 	Mbox($fileList)
...
;~ 	Mbox("asdfs")
	...
	Sleep(500)
	_OKIF($WindowHandle, "iconTK", 247, 240, 257, 253)
	_ClickUtilSeeImgNoSleep($WindowHandle, "iconBlueDTK", 38, 186)
;~ 	Nhap mat khau
	Sleep(400)
...
Func _Wait4Image($WindowHandle, $bmp)
	...
	While 1
		If _imgSearch($WindowHandle,$bmp)= 1 Then
			_CtrlClick($WindowHandle, $x, $y - 36)
	Sleep(200)
			_CtrlClick($WindowHandle, $x, $y - 36)
