...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $countBoss = 1, $x = 0, $y = 0, $Phu, $tenTK, $iniFile, $aPos, $aPoss, $rsMod, $sFilePathvang, $render_hwnd, $WindowHandle, $flag = 1, $motiec = 0, $flgMT = 0, $iGlobal, $fkexit = 0, $iGlobal1, $sv, $iVPN
...
;~ 		Mbox("123")
		...
		EndIf
	WEnd
			_WriteIni($iniFile, "General", "iVPN", 1 + _ReadIni($iniFile, "General", "iVPN", 1))
			If _ReadIni($iniFile, "General", "iVPN", 1) > 80 Then
				_WriteIni($iniFile, "General", "iVPN", 0)
				Sleep(5000)
