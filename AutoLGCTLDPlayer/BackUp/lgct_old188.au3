...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $x = 0, $y = 0, $tenTK, $iniFile, $aPos, $aPoss, $rsMod, $sFilePathvang, $render_hwnd, $WindowHandle, $flag = 1, $motiec = 0, $flgMT = 0, $iGlobal, $fkexit = 0, $iGlobal1, $sv
...
;~ 			$iGlobal1 = $iGlobal11
			...
			elseIf $infoAcc[2] <> 'tai' or $infoAcc[2] <> '='  Then
				$iGlobal = $iGlobal + 1
				ContinueLoop
			EndIf
...
;~ 			$Phu = $_Cung_Than
		Case 396, 461
			$Phu = $_Van_Tuyen
		Case 407, 586, 279, 284, 287, 278, 109, 111
			$Phu = $_Binh_Tay
		Case 381, 182, 380, 433, 461, 408, 148, 149
			$Phu = $_Tran_Nam
		Case 433
			$Phu = $_Bac_Tinh
		Case 416, 417, 415
...
;~ 	khu vuc sung bai bxh
	If Third($infoAcc, "9t") Or IniRead($iniFile, "General", "SV", 0) = "SV468" Or IniRead($iniFile, "General", "SV", 0) = "SV472" Or IniRead($iniFile, "General", "SV", 0) = "SV283" Or IniRead($iniFile, "General", "SV", 0) = "SV120" Or IniRead($iniFile, "General", "SV", 0) = "SV284" Then
