...
;~ 720x1280 320dpi
;~ _Singleton(
Global $port, $x = 0, $y = 0, $WindowHandle, $tenTK, $iniFile, $iGlobal, $iGlobal1, $aPos, $aPoss, $rsMod, $sFilePathvang, $SUB_LDPLAYER_HWND = DllStructCreate("hwnd"), $render_hwnd
...
Func __EnumWindowsProcLDPlayer($hwnd, $param)
	...
	Return True
EndFunc   ;==>__EnumWindowsProcLDPlayer
