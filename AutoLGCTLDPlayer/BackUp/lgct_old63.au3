...
Global $port, $x = 0, $y = 0, $WindowHandle, $tenTK, $iniFile, $iGlobal, $iGlobal1
...
;~ 	khu vuc sung bai bxh
		If Third("9t") Or IniRead($fileIni, "General", "SV", 0) = "SV283" Or IniRead($fileIni, "General", "SV", 0) = "SV341" Or IniRead($fileIni, "General", "SV", 0) = "SV338" Or IniRead($fileIni, "General", "SV", 0) = "SV555" Or IniRead($fileIni, "General", "SV", 0) = "SV487" Or IniRead($fileIni, "General", "SV", 0) = "SV574" Or IniRead($fileIni, "General", "SV", 0) = "SV281" Or IniRead($fileIni, "General", "SV", 0) = "SV284" Then
...
Func _ClearApp()
	...
	Sleep(2000)
;~ 	While 1
;~ 		If _imgSearch($WindowHandle, "iconClose") = 1 Or _imgSearch($WindowHandle, "iconCloseWhite") = 1 Then
;~ 			Sleep(100)
;~ 			ControlClick($WindowHandle, "", "", "left", 1, $x, $y)
;~ 			ExitLoop
;~ 		EndIf
;~ 	WEnd
;~ 	While 1
;~ 		If _imgSearch($WindowHandle, "clrButton") = 1  Then
;~ 			Sleep(100)
;~ 			Mbox("clrapp")
;~ 			ControlClick($WindowHandle, "", "", "left", 1, $x, $y)

;~ 			_Wait4Image($WindowHandle, "clrButton")
;~ 			Sleep(1500)
;~ 			ExitLoop
;~ 		EndIf
;~ 	WEnd
