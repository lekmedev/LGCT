...
;~ 		clone($WindowHandle, $infoAcc, $samePWD)
...
Func DoiCode()
	Local $code = IniRead($fileIni, "General", "code", 0)
;~ 	ClickUtilImg('DoiCode.bmp', 479, 641, 456, 34, 867, 760)
	_ClickUtilSeeImg($WindowHandle,"iconDoiCode",24, 409)
	Sleep(299)
	_Wait4Img($WindowHandle,"iconDoiCode")
	Sleep(300)
	_Wait4Img($WindowHandle,"iconNhapCode")
	Sleep(300)
;~ 	ClickUtilImg('BangNhapCode.bmp', $x7, $y7, 524, 344, 579, 381)
;~ 	While 1
;~ 		$aCoord = PixelSearch(526, 351, 534, 356, 0xA3A3A3)
;~ 		If Not @error Then
;~ 			ExitLoop
;~ 		EndIf
;~ 	WEnd
;~ 	Sleep(150)
;~ 	MouseClick("left", 655, 362, 1, 0)
;~ 	Sleep(100)
	ClipPut($code)
;~ 	Sleep(300)
;~ 	Send("^v")
