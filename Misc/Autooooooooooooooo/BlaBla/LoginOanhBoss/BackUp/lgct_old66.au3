...
;~ 	EndIf
Run(@ComSpec & ' /c ""C:\Program Files\ImageMagick-7.0.10-Q16\magick" convert "C:\Users\Admin\Pictures\MEmu Photo\' & $infoAcc[1] & '.png" -crop 42x20+538+110  "D:\Vang\Vang\' & _ReadIni($iniFile, "General", "SV", 0) & '\' & $infoAcc[1] & '.png""', "", @SW_HIDE)
EndFunc   ;==>_ThinhAn
